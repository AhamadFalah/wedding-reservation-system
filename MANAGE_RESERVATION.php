    ...
    <body>
        <div class="container-manage-reservations">
            ...
            <div class="container-reservations">
                <?php
                $id=$_SESSION["UID"];
                $sql = "SELECT * FROM reservation_data WHERE UserID=$id";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '          <h2 class="box-title">Reservation #' . $id . '</h2>';
                        echo '          <div class="box-info">';
                        echo '              <p class="box-info-d">Date: <b>' . $date. '</b></p>';
                        echo '              <p class="box-info-p" style="margin-left:10px;">Venue: <b>' .$venue.'</b></p>';
                        echo '              <p class="box-info-p style="margin-right:50px;"">Package: <b>' .$package. '</b></p>';
                        echo '              <p class="box-info-p">Guests: <b>' .$guest . '</b></p>';
                        echo '              <p class="box-info-p">Status: <b>' .$status. '</b></p>';
                        echo '          </div>';
                        echo '      </div>';
                        echo '  </div>';
