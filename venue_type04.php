...
table:hover{
  ...
  box-shadow: 10px 15px 20px  black;
    ...
    <body>
        <CENTER> <br><br>
            <h1 >Banquet Hall</h1>
            <p style="margin-top:40px; margin-left: 80px; margin-right:80px;" >Welcome to our extraordinary banquet hall, the perfect setting for your unforgettable wedding. Our banquet hall combines exquisite details with impeccable service, ensuring every moment of your special day is nothing short of perfection.
             Indulge in a delightful culinary experience and dance the night away in our enchanting space

            </p> 
            <br/><br/><br/>
            <image src="images/venue04.1.jpg" class="pic" > </image>
            <image src="images/venue04.2.jpg" class="pic"  > </image>
            <image src="images/venue04.3.jpg" class="pic" > </image>
...
<div class="cont">
    <div class="card">
        ...
        <div class="intro"> <h3>Arrangement 1</h3> <p> Capacity 1000</p></div>
</div>
<div class="card">
    <image src="images/seating2.png" ></image> 
    <div class="intro"> <h3>Arrangement 2</h3> <p> Capacity 850</p></div>
</div>
<div class="card">
    <image src="images/seating3.png"></image> 
    <div class="intro"> <h3>Arrangement 3</h3> <p> Capacity 750</p></div>
</div>
</div>
<BR></BR>
