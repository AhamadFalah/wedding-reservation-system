...
table:hover{
  ...
  box-shadow: 10px 15px 20px  black;
    ...
    <body>
        <CENTER> <br><br>
            <h1 >Grand Lawn</h1>
            <p style="margin-top:40px; margin-left: 80px; margin-right:80px;" >A Welcome to Grand Lawn Venue, where grandeur meets elegance for an unforgettable wedding experience. Our meticulously manicured lawn sets the stage for a captivating celebration. 
                  With spacious dressing suites, impeccable service, and an enchanting atmosphere, create lasting memories at Grand Lawn Venue.

            </p> 
            <br/><br/><br/>
            <image src="images/venue02.1.jpg" class="pic" > </image>
            <image src="images/venue02.2.jpg" class="pic"  > </image>
            <image src="images/venue02.3.jpg" class="pic" > </image>
...
<div class="cont">
    <div class="card">
        ...
        <div class="intro"> <h3>Arrangement 1</h3> <p> Capacity 800</p></div>
</div>
<div class="card">
    <image src="images/seating2.png" ></image> 
    <div class="intro"> <h3>Arrangement 2</h3> <p> Capacity 650</p></div>
</div>
<div class="card">
    <image src="images/seating3.png"></image> 
    <div class="intro"> <h3>Arrangement 3</h3> <p> Capacity 550</p></div>
</div>
</div>
<BR></BR>
...
<section class="main">
    <div class="full-box">
        <div class="comment-box">
            ...
            <div class="comment">
                <p> Review: Grand Lawn is a gem of a wedding venue! The beachfront view is stunning, 
        ...
        <div class="comment-box">
            ...
            <div class="comment">
                <p> Review: Our wedding at Grand Lawn was a dream come true. The venue is stunning, the staff is attentive, 
        ...
        <div class="comment-box">
            ...
            <div class="comment">
                <p>Review: Grand Lawn exceeded our expectations. The staff was helpful, the beach was pristine,
        ...
        <div class="comment-box">
            ...
            <div class="comment">
                <p> Review: Grand Lawn is a slice of paradise. The beachfront location, beautiful venue, 
